...
![The about page]({{"/assets/Screenshot2026-09-14121347.png" | relative_url}}){: width="300" }

The movies page lists the avaliable movies and they can be searched through using the search bar on top.\
![The Movies Page]({{"/assets/Screenshot2026-09-14121401.png" | relative_url}}){: width="300" }
...
![The Avatar Page]({{"./assets/Screenshot2026-09-14121434.png" | relative_url}}){: width="300" }
...
![The Sign Up Page]({{"./assets/Screenshot2026-09-14124805.png" | relative_url}}){: width="300" }
![The Login Page]({{"./assets/Screenshot2026-09-14124824.png" | relative_url}}){: width="300" }
...
![Review Page]({{"./assets/Screenshot2026-09-14121503.png" | relative_url}}){: width="300" }

Here we made a review and you can see how for our own review, we have options to delete and edit it.\
![Added a review]({{"./assets/Screenshot2026-09-14121618.png" | relative_url}}){: width="300" }

If we choose to edit the review, we get to this website where we can make changes.\
![Edit a review]({{"./assets/Screenshot2026-09-14121659.png" | relative_url}}){: width="300" }
...
![Reported review]({{"./assets/Screenshot2026-09-14121714.png" | relative_url}}){: width="300" }

### Purchases
Users can add movies to their cart to purchase later.\
![Cart]({{"./assets/Screenshot2026-09-14121951.png" | relative_url}}){: width="300" }

Page when you click 'Purchase':\
![Completed order]({{"./assets/Screenshot2026-09-14122003.png" | relative_url}}){: width="300" }

Order page to see your orders:\
![Order pages]({{"assets/Screenshot2026-09-14122028.png" | relative_url}}){: width="300" }
